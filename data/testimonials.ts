...
const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    content:
      "As a business owner, I needed a contractor who could complete our office renovation with minimal disruption. The team at PCF not only delivered exceptional quality but worked around our schedule to ensure our business operations weren't affected. The result is a beautiful, functional space that our employees love.",
  },
  {
    name: "Jennifer & Michael Taylor",
    role: "Whole Home Renovation",
    content:
      "We entrusted PCF with our century home renovation, which required both preserving historical elements while modernizing essential systems. Their knowledge, creativity, and craftsmanship exceeded our expectations. Five years later, the quality of their work still impresses everyone who visits our home.",
  },
];
