          ...
          <div className="px-6 py-10 sm:px-10 sm:py-12 md:py-16 grid md:grid-cols-3 gap-10 items-center">
            ...
            <div className="col-span-1 flex justify-center">
              <Button
                href="/contact"
                variant="primary"
                className="inline-flex items-center justify-center px-8 py-4 text-base font-medium rounded-md bg-[#bd5d18] hover:bg-[#a34e14] shadow-md"
              >
                BOOK NOW
              </Button>
            </div>
            ...
            <div className="col-span-1 flex flex-col md:items-end">
              <div className="flex items-center justify-start md:justify-end mb-2">
                <div className="bg-[#bd5d18] rounded-full p-3 mr-4">
                  <svg
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-xl font-bold text-[#bd5d18] hover:text-[#a34e14]"
                  >
                    +1 613-302-5268
                  </a>
                </div>
